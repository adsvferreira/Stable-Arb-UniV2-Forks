...
from modules.chainlink import ChainlinkPriceContract
...
class Erc20Token:
    ...
    def __init__(
        ...
        target_swap_ratio: Decimal = None,
    ) -> None:
        ...
        with catch_warnings():
            ...
            try:
                ...
                if abi:
                    try:
                        self._contract = Contract.from_abi(name="", address=self.address, abi=abi)
                    except:
                        raise
    ...
    def __eq__(self, other) -> bool:
        assert isinstance(other, Erc20Token), "Equality can only be evaluated against another Erc20Token"
    ...
    def set_target_swap_ratio(self, target_swap_ratio: float):
        self.target_swap_ratio = Decimal(target_swap_ratio)
